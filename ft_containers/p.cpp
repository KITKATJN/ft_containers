...
template <class Key, class T, class Compare = ft::less<Key>, class Allocator = std::allocator<ft::pair<const Key,T> > >
    ...
    public:
        ...
        map(const map& x) :
        m_tree(rbtree<value_type, value_compare, allocator_type>(value_compare(Compare()), Allocator()))
        {
        ...
        iterator            insert (iterator position, const value_type& val) { return m_tree.insert(position, val); }
        ...
        size_type   erase (const key_type& k) { return m_tree.erase(ft::make_pair(k, mapped_type())); }
        ...
        key_compare     key_comp() const { return m_tree.value_comp()._comp; }
        ...
        size_type       count (const key_type& k) const { return m_tree.count(ft::make_pair(k, mapped_type())); }
        ...
        pair<const_iterator,const_iterator> equal_range (const key_type& k) const { return m_tree.equal_range(ft::make_pair(k, mapped_type()));}
        pair<iterator,iterator>             equal_range (const key_type& k) { return  m_tree.equal_range(ft::make_pair(k, mapped_type()));}
